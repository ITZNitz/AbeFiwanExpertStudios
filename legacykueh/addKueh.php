    ...
    <div class="w3-row">
        ...
        <div class="w3-round-large w3-row" style="margin:10px; z-index:0">
            ...
            <div class="w3-round-large w3-border" style="margin-left:15.6%; z-index:9999;"> <!--main content-->
                ...
                <div class="w3-container w3-border-top w3-round-large w3-rest w3-white w3-row fixed-header"
                    style="width: 83.4%; margin-top: 8px; padding:8px">
                        ...
                        <form class="" method="GET" action='purchase_listing.php'>
                            ...
                            <div class="w3-col w3-round w3-white w3-border w3-round-xxlarge w3-padding">
                                <img src="data:image/png;base64,"
                                    alt="Cari Kueh"
                                    style="padding-bottom:3px;margin-right:8px;text-align:center; width:25px">
                                <input type="text" class="w3-cell w3-input" style="width: 85%; height: 25px;"
                                    placeholder="Cari kuih-muih dan resipi">
                    ...
                    ?>
                        ...
                        <div class="w3-cell w3-right" style="margin-right: 15px;"> <!--LOGIN (HIDDEN)-->
                            <a href="login.php" class="w3-bar-item w3-button w3-round-large w3-border"
                                style="margin-left :6px ;width: 94%; text-align: left;">
                                LogMasuk
                            </a><br>
                    ...
                    ?>
                        ...
                        <div class="w3-cell w3-right" style="margin-right: 15px;"> <!--logout (HIDDEN)-->
                            <a href="logout.php" class="w3-bar-item w3-button w3-round-large w3-border"
                                style="margin-left :6px ;width: 94%; text-align: left;">
                                LogKeluar
                            </a><br>
                        ...
                        <div class="w3-cell w3-right" style="margin-right: 15px; "> <!--PROFILE (HIDDEN)-->
                            ...
                            <img src="data:image/png;base64,"
                                alt="test-account" style="text-align:center; width:40px">
                            <?php
                ...
                <div class="w3-round-large" style="height: 92%; margin-top: 4%">
                    ...
                    <div class="w3-container w3-white" style="margin-top:5px;width: 100%; height: 100%;">
                        ...
                        <div class="w3-panel w3-yellow w3-border w3-animate-fading">
                            ...
                            <p>This website is currently under development. Some features may not be fully functional or
                                available at this time. We appreciate your understanding and welcome your feedback to
                                improve the platform.</p>
                        </div>
                        <br><br>
                        <div class="w3-container" style="margin-left:10%">
                            <h3><b>Tentang Kami</b></h3>
                            <p>Matlamat kami adalah untuk <b>menjadikan penyediaan dan perkongsian resipi kueh sebagai
                                    satu pengalaman yang menyeronokkan.</b> Kami percaya bahawa kueh tradisional <br>
                                memainkan peranan penting dalam <b>mengeratkan hubungan, melestarikan budaya, dan
                                    mencipta gaya hidup yang lebih bermakna.</b> Dengan platform kami, kami
                                memperkasakan <br> individu untuk berkongsi resipi dan ilmu berkaitan kueh, demi
                                memelihara warisan serta menghubungkan komuniti.</p>
                        </div>

                        <div class="w3-container w3-center">

                            <p>Hak Cipta &copy AbeFiwan Expert Studio. Hak Cipta Terpelihara</p>
